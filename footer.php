...
<footer class="mastfoot mt-auto text-center">
	...
	<div class="items">
			...
			<?php endforeach;	?>
		<h5>SEGUINOS</h5>
		<a href="https://instagram.com"><img style="width: 25px;" src="ImgJeziel/instagram.svg" alt="instagram"></img></a>
		<a href="https://facebook.com"><img style="width: 25px;" src="ImgJeziel/facebook.svg" alt="facebook"></img></a>
		<a href="https://twitter.com"><img style="width: 25px;" src="ImgJeziel/twitter.svg" alt="twitter"></img></a>
	</div>
	<div>
